...
(100,'Gral_San_Martin','San Salvador','Jujuy',100),
...
('Carlos Guido y Spano','Capital Federal','Buenos Aires',1250),
('Paula Albarracín de Sarmiento','Tres Arroyos','Buenos Aires',1100),
('Escuela Nro.392','Sijan','Catamarca',250),
('General Las Heras','Las Heras','Córdoba',1500),
('E.E.P. Nro.852','El Sauzalito','Chaco',452);
/*
